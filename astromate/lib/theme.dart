...
class Themes{
  ...
  ThemeData lightTheme = ThemeData(
      ...
      textTheme: ThemeData.light().textTheme.copyWith(
          ...
          subtitle1: TextStyle(color: blue, fontSize: 25, fontFamily: 'Agency', fontWeight: FontWeight.bold),
          subtitle2: TextStyle(color: blue, fontSize: 20, fontFamily: 'Agency'),
          headline1: TextStyle(color: Colors.white, fontSize: 30, fontFamily: 'Agency', fontWeight: FontWeight.bold),
      ),
  );
  ...
  ThemeData darkTheme = ThemeData(
      ...
      textTheme: ThemeData.light().textTheme.copyWith(
          ...
          subtitle1: TextStyle(color: red, fontSize: 25, fontFamily: 'Agency', fontWeight: FontWeight.bold),
          subtitle2: TextStyle(color: red, fontSize: 20, fontFamily: 'Agency'),
          headline1: TextStyle(color: red, fontSize: 30, fontFamily: 'Agency', fontWeight: FontWeight.bold),
      ),
  );
